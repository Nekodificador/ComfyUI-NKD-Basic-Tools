...
Paints a mask onto an image that doesn't exist as a file yet, anything your graph
just generated, without saving it out and loading it back in. Drop the node
anywhere in the chain, hit **Edit**, and you get ComfyUI's own mask editor on that
image. Out come the image, the mask and its inverse.
...
them while the result stays paintable. See
[Vector Mask or Mask Painter?](vector-mask.md#vector-mask-or-mask-painter)
